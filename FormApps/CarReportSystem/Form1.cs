...
#pragma warning restore SYSLIB0011
                    using (FileStream fs =File.Open(
                        ofdopenFile.FileName,FileMode.Open,FileAccess.Read)) { }
                    ...
                    foreach (var c in listCarReports) {
                        SetCbAuthor(c.Author);
                        SetCbCarName(c.CarName);
                    }
